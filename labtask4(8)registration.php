...
<body>
<div><?php include 'basic/header.php';?></div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 if ($flag==1) {
    ...
    {
 	if(file_exists('basic/data.json'))
 		{ $current_data = file_get_contents('basic/data.json');  
      ...
      $extra = array(  
            ...
            if(file_put_contents('basic/data.json', $final_data))  
            {  
